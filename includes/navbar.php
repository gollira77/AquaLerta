    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="admin.php">Gestión de Alertas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="historial.php">Historial de Alertas</a>
                </li>
                <li class="nav-item">
              ...
              <li class="nav-item">
                    <a class="nav-link" href="gestion_usuarios.php">Gestión Usuarios</a> </li>
             <li class="nav-item">
